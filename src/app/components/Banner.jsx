...
const Banner = () => {
  return (
    ...
    style={{
      backgroundImage: "url(http://res.cloudinary.com/dzzyhqpnk/image/upload/v1735192560/dofcrj3257myvifi8trq.png)"
    }}
    >
      ...
      <div className="relative z-10 grid justify-center items-center h-[356px] lg:h-[550px] text-white py-20 md:p-8">
        <div>
          ...
          <p className="text-[20px] md:text-[32px] font-bold w-[65%] mx-auto text-center"> “  The Essence of a Holiday is to Enrich 
